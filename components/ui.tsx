...
export const Bdg = React.memo(function Bdg({ type, children }: { type: "tfn" | "abn" | "ot" | "bank" | "mixed" | "danger"; children: React.ReactNode }) {
  const s: Record<string, React.CSSProperties> = {
    ...
    mixed:  { background: "var(--color-background-tertiary)", color: "var(--color-text-secondary)" },
